...
class AccessContext:
    ...
    def institution_ids(self) -> set[UUID]:
        return {
            ...
            for assignment in self.assignments
            if assignment.scope_type in {"institution", "academic_compartment"} and assignment.institution_id is not None
        }
    ...
    def academic_compartment_ids(self) -> set[UUID]:
        return {
            ...
            for assignment in self.assignments
            if assignment.scope_type == "academic_compartment" and assignment.academic_division_id is not None
        }
